<template>
      <div class="lg:max-w-[920px] m-1">
            ...
            <form action="" class="space-y-3 mt-6 w-2/3 max-lg:w-full">
                ...
                <div @click="nextPage.goToNextPage('project-timeline/implementation-schedule')"  class="btn btn-xl rounded-xl btn-primary btn-gradient btn-block text-base border-none lg:max-w-60 lg:h-12 my-3">Save & Continue <span class="icon-[tabler--chevron-right] size-5"></span></div>
            </form>
    </div>
</template>
