...
<script setup>
import { businessHistorySchema } from '~/validation/formValidationSchama';
...
const { value: firstYearRevenue, errorMessage: firstYearRevenueError } = useField('firstYearRevenue')
const { value: secondYearRevenue, errorMessage: secondYearRevenueError } = useField('secondYearRevenue')
const { value: thirdYearRevenue, errorMessage: thirdYearRevenueError } = useField('thirdYearRevenue')
const { value: totalAssets, errorMessage: totalAssetsError } = useField('totalAssets')
...
onMounted(async () => {
    ...
    try {
        ...
        if (profileStore.projectId) {
            ...
            console.log('Sponsorship business history:', sponsorshipStore.sponsorship);
