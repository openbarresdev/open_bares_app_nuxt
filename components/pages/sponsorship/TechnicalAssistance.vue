            ...
            <form @submit.prevent="submitTechnicalAssistance" class="mt-8 w-full">
                <div class="space-y-6 mx-1 lg:w-1/2 max-lg:w-full">
                    <div class="inline-flex items-center gap-2 w-full">
                        <div class="lg:text-base max-lg:text-sm w-1/2">Management Assistance</div>
                    ...
                    <div class="inline-flex items-center gap-2 w-full">
                        <div class="lg:text-base max-lg:text-sm w-1/2">Production Assistance</div>
                        <CommonInputsVariant class="w-full"
                            type="text"
                    ...
                    <div class="inline-flex items-center gap-2 w-full">
                        <div class="lg:text-base max-lg:text-sm w-1/2">Marketing Assistance</div>
                        <CommonInputsVariant class="w-full"
                            type="text"
                    ...
                    <div class="inline-flex items-center gap-2 w-full">
                        <div class="lg:text-base max-lg:text-sm w-1/2">Financial Assistance</div>
                        <CommonInputsVariant class="w-full"
                            type="text"
...
<script setup>
import { technicalAssistanceSchema } from '~/validation/formValidationSchama';
...
const { value: managementAssist, errorMessage: managementAssistError } = useField('managementAssist')
const { value: productionAssist, errorMessage: productionAssistError } = useField('productionAssist')
const { value: marketingAssist, errorMessage: marketingAssistError } = useField('marketingAssist')
const { value: financialAssist, errorMessage: financialAssistError } = useField('financialAssist')
...
onMounted(async () => {
    ...
    try {
        ...
        if (profileStore.projectId) {
            ...
            console.log('Sponsorship technical assistance:', sponsorshipStore.sponsorship);
...
const submitTechnicalAssistance = handleSubmit(async (values) => {
    ...
    try {
        ...
        await sponsorshipStore.saveSponsorshipSection(profileStore.projectId, 'technicalAssistance', values);
