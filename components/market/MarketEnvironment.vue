<template>
    <div>
        ...
        <div class="btn btn-xl rounded-xl btn-primary btn-gradient btn-block text-base border-none lg:max-w-60 lg:h-12 my-3">Submit & continue <span class="icon-[tabler--chevron-right] size-5"></span></div>
