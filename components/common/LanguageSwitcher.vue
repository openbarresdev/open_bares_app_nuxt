<template>
  <div class="relative">
    <div class="absolute -top-5 right-0 z-50">
      <button class="btn text-sm bg-zinc-200 hover:bg-zinc-100 text-black border-zinc-200 shadow-none rounded-2xl py-2" @click="showDropdown = !showDropdown">
      ...
      <div ref="dropdownRef" v-show="showDropdown" class="flex flex-col justify-start w-full bg-white shadow-2xl rounded-2xl text-sm px-2 py-1">
