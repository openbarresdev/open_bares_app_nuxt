<template>
    <div>
        <nav class="navbar rounded-box shadow-base-300/20 z-1 h-16 shadow-md max-lg:p-2 w-full lg:justify-between">
            ...
            <button type="button" class="btn btn-soft btn-square me-2 lg:hidden w-full max-w-10" @click="$emit('toggleAside')">
                <span class="icon-[tabler--menu-2] size-5"></span>
            </button>
            ...
            <div @click="logoutUser"
                ...
                data-overlay="#middle-center-modal" ria-haspopup="dialog" aria-expanded="false">
